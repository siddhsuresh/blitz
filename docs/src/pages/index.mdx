      ...
      <div className="overflow-hidden">
        <div>
          <div className="relative grid grid-cols-1 pb-1 md:pb-3 gap-y-24 xl:gap-y-44">
            ...
            <div
              className=
                "absolute w-full h-full row-start-1 row-end-5 background-to-video rounded-bl-3xl xl:rounded-bl-4xl bg-gradient-to-tr from-purple-mid to-purple-primary dark:from-black dark:to-purple-off-black "
            ></div>
            ...
            <div className="text-black dark:text-white relative w-full mx-auto space-y-10 lg:space-y-20 xl:space-y-36 max-w-7xl">
...
> </iframe>
            ...
            <div className="text-black dark:text-white px-6 mx-auto text-center max-w-7xl ">
            ...
            <div className="w-full px-6 mx-auto space-y-12 text-white lg:space-x-4 lg:space-y-0 lg:flex lg:items-center max-w-7xl md:pb-36">
