...
import {SponsorPack} from "../components/home/SponsorPack"
import {getGitHubFile} from "../utils/getGitHubFile"
import {ButtonLink} from "../components/home/ButtonLink"
import { CodeW } from "../components/home/CodeWindow"
      ...
      <div className="overflow-hidden">
        <div>
          ...
          <div className="relative grid grid-cols-1 pb-1 md:pb-3 gap-y-24 xl:gap-y-44">
            <div className="z-30 text-white col-span-full"></div>
            <div
              className={
              ...
              <div className="grid grid-cols-1 gap-10 px-6 mx-auto max-w-7xl lg:grid-cols-2 md:gap-6 xl:-mt-10">
                <div className="z-10 lg:w-full">
                  <div className="flex flex-col -mt-8 lg:mt-16 xl:mt-10">
                    ...
                    <div className="order-last font-medium text-2xl xl:text-3xl font-secondary xl:font-medium text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-yellow-400 dark:from-yellow-100 dark:to-yellow-300">
                      The Missing Fullstack Toolkit for Next.js
                    </div>
                    <div className="font-medium text-7xl font-secondary xl:text-8xl xl:font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-gradient-white to-blue-gradient-light-blue tracking-tight xl:tracking-tighter mb-4 xl:mb-8 ">
                      Ship. Fast.
                    </div>
                  </div>
                  <div className="mt-6 xl:mt-8 text-lg xl:text-2xl xl:font-medium text-off-white lg:text-transparent lg:bg-clip-text lg:bg-gradient-to-r lg:from-blue-gradient-white lg:to-blue-gradient-light-blue ">
            ...
            <div className="relative w-full mx-auto space-y-10 lg:space-y-20 xl:space-y-36 max-w-7xl">
              <div className="px-6 text-3xl font-semibold xl:text-5xl xl:w-1/2">
            ...
            <div className="relative hidden w-full px-6 mx-auto space-y-10 max-w-7xl lg:block">
              <div className="pb-1 text-xs border-b border-opacity-50 font-secondary border-blue-mid">
                Blitz CodeSandbox Example
              </div>
              <div>
                <Hand variant="sandbox-right" style={{right: "-13.2rem", bottom: "-35rem"}} />
                <iframe src="https://codesandbox.io/embed/github/siddhsuresh/Blitzjs-Codesandbox-Demo/tree/main/?fontsize=14&hidenavigation=1&theme=dark"
     style={{width:"100%",height:"500px", border:"0", borderRadius: "4px", overflow:"hidden", zIndex: "10"}}
     title="Blitzjs-Codesandbox-Demo"
   ...
   ></iframe>
            ...
            <div className="relative flex flex-col px-6 mx-auto text-white lg:flex-row max-w-7xl space-y-14 lg:space-x-24 lg:space-y-0 xl:space-x-40">
              <div className="space-y-14 lg:w-1/2">
                <div className="z-10 font-medium text-transparent text-5xl-squashed font-secondary bg-clip-text bg-gradient-to-r from-blue-gradient-white to-blue-gradient-light-blue xl:text-6xl">
