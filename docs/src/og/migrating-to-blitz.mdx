...
[standalone route](https://nextjs.org/docs/routing/introduction), pages
like `pages/products/index.tsx` will route to `example.com/store/products`
in your application.
...
inside `blitz.config.ts` to have some subpaths to be proxied to your
existing app.
...
To learn more about rewrites, take a look at the Next.js
